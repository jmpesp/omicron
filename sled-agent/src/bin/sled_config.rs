...
fn main() -> Result<()> {
            ...
            rack_network_config: RackNetworkConfig {
                ...
                ports: UplinkPorts::new(vec![
                    PortConfig {
                        ...
                        uplink_port_speed: LinkSpeed::Speed10G,
                        // XXX otherwise see
    ...
    let sled_config = SledConfig {
        ...
        sidecar_revision: SidecarRevision::CanadaRegion,
        ...
        external_disks: vec![
            ...
            ExternalDisks::HardcodedPhysical { disks: {
        ...
        data_links: if MULTI_SWITCH_MODE {
            match hostname {
                "dinnerbone" => DataLinks::Virtual { devices: vec!["ixgbe0".to_string(), "igb0".to_string()] },
                ...
                // switch zone one
                "kibblesnbits" => DataLinks::Virtual { devices: vec!["ixgbe0".to_string(), "e1000g5".to_string()] },

                "gravytrain" => DataLinks::Virtual { devices: vec!["ixgbe0".to_string(), "igb0".to_string()] },
                ...
                // zone one
                "frostypaws" => DataLinks::Virtual { devices: vec!["ixgbe3".to_string(), "igb0".to_string()] },

                _ => panic!("unknown hostname {}", hostname),
            }
        } else {
            match hostname {
                "dinnerbone" => DataLinks::Virtual { devices: vec!["ixgbe0".to_string(), "net1".to_string()] },
                "kibblesnbits" => DataLinks::Virtual { devices: vec!["ixgbe0".to_string(), "net1".to_string()] },
                "gravytrain" => DataLinks::Virtual { devices: vec!["ixgbe0".to_string(), "net1".to_string()] },
                "frostypaws" => DataLinks::Virtual { devices: vec!["ixgbe3".to_string(), "net1".to_string()] },
                _ => panic!("unknown hostname {}", hostname),
            }
        },
                ...
                location: omicron_gateway::LocationConfig {
                    ...
                    description: vec![
                        omicron_gateway::LocationDescriptionConfig {
                            name: String::from("switch0"), // XXX ?
                            local_sled: 3, // XXX 14?
                            allow_local_sled_sp_reset: false,
                        },
                        // XXX MULTI SWITCH MODE?
                        omicron_gateway::LocationDescriptionConfig {
                            name: String::from("switch1"), // XXX ?
                            local_sled: 1, // XXX 14?
                            allow_local_sled_sp_reset: false,
                        },
                    ],
