...
impl NexusExternalApi for NexusExternalApiImpl {
    ...
    async fn scim_idp_create_token(
        ...
        HttpResponseCreated<views::ScimBearerTokenCreateResponse>,
        HttpError,
    > {
        let apictx = rqctx.context();
        let handler = async {
    ...
    async fn scim_idp_delete_all_tokens(
        ...
        let handler = async {
            ...
            nexus.scim_idp_delete_tokens_for_silo(&opctx, &silo_lookup).await?;
    ...
    async fn scim_v2_create_user(
        ...
        let handler = async {
            ...
            nexus.scim_v2_create_user(&rqctx.request, body.into_inner()).await
        };
        apictx
            .context
            .external_latencies
    ...
    async fn scim_v2_delete_user(
        ...
        let handler = async {
            ...
            nexus.scim_v2_delete_user(&rqctx.request, path_params.user_id).await
        };
        apictx
            .context
            .external_latencies
    ...
    async fn scim_v2_create_group(
        ...
        let handler = async {
            ...
            nexus.scim_v2_create_group(&rqctx.request, body.into_inner()).await
        };
        apictx
            .context
            .external_latencies
