...
// XXX tests:
// logging in after user create
// logging in after user put
// logging in after user patch?
// logging in after user active = false
//  - or basic list projects
// logging in after user delete
//  - or basic list projects
// logging in after silo scim client deleted
...
#[nexus_test]
async fn test_silo_with_saml_scim(cptestctx: &ControlPlaneTestContext) {
